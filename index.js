...
const cevresi = CemberinCevresi(5);
console.log("Çemberin çevresi: " + cevresi);
...
for (let num in countObj) {
  if (countObj[num] > 1) {
    tekraredensayilar.push(`${num} sayısı ${countObj[num]} kere tekrar edilmiştir`);
  }
}
